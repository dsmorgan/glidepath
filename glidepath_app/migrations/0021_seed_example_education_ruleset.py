...
An aggressive-to-conservative path keyed on years-to-enrollment (negative =
already enrolled), covering -100..100 with no gaps. Class allocations split into
the same asset categories the NYSaves 529 funds explode into, so the education
dashboard's current-vs-target drift is meaningful out of the box.
...
# (gt_years, lt_years, stocks_pct, bonds_pct) — years to enrollment.
BANDS = [
    (-100, 0, 20, 80),   # enrolled / drawing down
    (0, 2, 30, 70),
    (2, 5, 50, 50),
    (5, 10, 70, 30),
    (10, 15, 80, 20),
